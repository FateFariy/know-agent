...
var (
	...
	ErrTaskNotFound             = common.NewBizError(20015, "任务不存在：%d")
	...
	ErrDocumentBlocksMissing    = common.NewBizError(20018, "当前文档没有可用于切块的结构化 blocks")
	...
	ErrKnowledgeConfigNotFound  = common.NewBizError(20022, "知识库配置不存在: %d")
)

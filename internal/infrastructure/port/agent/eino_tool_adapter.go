...
func NewEinoToolAdapter[I, O any](t tool.Tool[I, O]) *EinoToolAdapter[I, O] {
...
func (t *EinoToolAdapter[I, O]) InvokableRun(ctx context.Context, argumentsInJSON string, _ ...einotool.Option) (string, error) {
	var args I

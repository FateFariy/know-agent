...
var ProviderSet = wire.NewSet(
	...
	wire.Bind(new(documentadapter.VectorRetriever), new(*vector.MilvusVector)),
	wire.Bind(new(chatadapter.VectorRetriever), new(*vector.MilvusVector)),
	keyword.NewKeywordDB,
	wire.Bind(new(documentadapter.KeywordRetriever), new(*keyword.KeywordDB)),
	wire.Bind(new(chatadapter.KeywordRetriever), new(*keyword.KeywordDB)),

...
func NewAmbiguityResolver(svcCtx *svc.ServiceContext, chatModel chatlogic.ObservedChatModelImpl[*schema.Message], promptTemplate chatlogic.PromptTemplateLogic) *AmbiguityResolver {

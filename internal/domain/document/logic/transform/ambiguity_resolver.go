...
type AmbiguityResolver struct {
	chatModel      chatlogic.ChatModelImpl[*schema.Message]
...
func NewAmbiguityResolver(svcCtx *svc.ServiceContext, chatModel chatlogic.ChatModelImpl[*schema.Message], promptTemplate chatlogic.PromptTemplateLogic) *AmbiguityResolver {

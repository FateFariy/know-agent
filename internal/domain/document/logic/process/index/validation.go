...
func NewValidationPhase(repo adapter.DocumentRepository) *ValidationPhase {
	return &ValidationPhase{repo: repo}
}
...
func (p *ValidationPhase) Execute(ctx context.Context, buildCtx *Context) error {
...
func (p *ValidationPhase) applyGraphFailureDisposition(ctx context.Context, buildCtx *Context, cause error) {

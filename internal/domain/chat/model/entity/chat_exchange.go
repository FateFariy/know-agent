...
type ChatExchange struct {
	...
	SelectedKnowledgeBaseIds   common.JSONArray `gorm:"column:selected_knowledge_base_ids_json;type:json"`   // 选中知识库ID列表JSON
	SelectedKnowledgeBaseNames common.JSONArray `gorm:"column:selected_knowledge_base_names_json;type:json"` // 选中知识库名称列表JSON
